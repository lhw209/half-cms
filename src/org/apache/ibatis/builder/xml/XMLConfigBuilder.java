        ...
        if (context != null) {
            ...
            for (XNode child : context.getChildren()) {
                ...
                if (isSpecifiedEnvironment(id)) {
                    ...
                    Environment.Builder environmentBuilder = new Environment.Builder(id).transactionFactory(txFactory).dataSource(
                            dataSource);
            ...
            for (XNode child : parent.getChildren()) {
                if ("package".equals(child.getName())) {
                    ...
                    if (resource != null && url == null && mapperClass == null) {
                        ...
                        XMLMapperBuilder mapperParser = new XMLMapperBuilder(inputStream, configuration, resource, configuration
                                .getSqlFragments());
                        mapperParser.parse();
                    }
